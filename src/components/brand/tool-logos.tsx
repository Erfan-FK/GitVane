/**
 * Official monochrome brand marks for the AI coding tools GitVane targets.
 * Path data is sourced from the projects' own brand glyphs (via Simple Icons)
 * and rendered with `currentColor` so each mark inherits the surrounding text
 * color and works in both light and dark themes.
 */
...
/** Anthropic / Claude — official "A" mark. */
